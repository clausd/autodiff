...
class MatrixTest < Test::Unit::TestCase
  ...
  def test_product
    m = Autodiff::Matrix.new(2,2)
    n = Autodiff::Matrix.new(2,2)
    product = m*n
  ...
  def test_gradient
    v1 = Autodiff::Matrix.new(1,5) #row vector
    ...
    assert_equal [2,4,6,8,10], v1.gradient
  end
  ...
  def test_apply
    ...
    assert_equal [2,4,6,8], m.gradient
    # binding.pry
  end
